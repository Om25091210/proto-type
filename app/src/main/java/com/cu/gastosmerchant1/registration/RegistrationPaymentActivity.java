...
public class RegistrationPaymentActivity extends AppCompatActivity {
    Button payBtn;
    TextView payAmt;
...
//                                account_information.setIntern(null);
    ...
    private void upiPay(PaymentApp app) {
        ...
        try {
            ...
            easyUpiPayment.setPaymentStatusListener((PaymentStatusListener) RegistrationPaymentActivity.this);
